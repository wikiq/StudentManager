                    ...
                    <div class="layui-card-body">
                        <div class="welcome-module">
                            <div class="layui-row layui-col-space10 layuimini-qiuck">
                                ...
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="teacher/teacher_student_list.jsp" data-title="租户查询" data-icon="fa fa-pencil">
                                        <i class="fa fa-pencil"></i>
                                        <cite>租户查询</cite>
                                    </a>
                                </div>
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="teacher/teacher_open_course_list.jsp" data-title="结果管理" data-icon="fa fa-graduation-cap">
