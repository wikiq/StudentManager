...
<body>
    <div class="layui-form">
        <table class="layui-table">
            ...
            <tbody id="tbody1">
                <%--<tr>
                    <td>2020710001</td>
                    <td>张无忌</td>
                    <td><input type="number" placeholder="请输入结果进度" value="0" name="score" class="layui-input"></td>
                </tr>--%>
            </tbody>
        ...
        <div style="text-align: center">
            <button type="submit" class="layui-btn layui-btn-normal"  lay-submit lay-filter="data-save-btn">完成结果录入</button>
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $.each(res,function (i, n) {
                    $('#tbody1')
                        .append("<tr> <td>"+n.snum+"</td> <td>"+n.sname+"</td> <td><input type=\"number\" placeholder=\"请输入结果进度\" value=\""+n.score+"\" name=\""+n.sid+"\" class=\"layui-input\"></td> </tr>");
                })
            }
        });
        ...
        layui.use('form', function(){
            ...
            form.on('submit(data-save-btn)', function(data){
                ...
                $.ajax({
                    ...
                    datatype: 'json',
                    success: function (res) {
                        layer.msg("更新"+res+"个结果成功",{time:1000});
                    }
                });
                return false;
            });
