...
<div class="site-text" style="margin: 5%; display: none" id="edit_window">
    <div class="layui-form" style="width: 400px; float: left" lay-filter="editForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" id="snum" name="snum" value="" lay-verify="required" lay-reqtext="用户号不能为空" placeholder="请输入用户号" class="layui-input">
            </div>
        </div>
        <!--性别-->
        <div class="layui-form-item">
    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-normal layui-btn-sm data-add-btn" lay-event="add"> 添加租户 </button>
                <button class="layui-btn layui-btn-sm layui-btn-danger data-delete-btn" lay-event="delete"> 删除选中行 </button>
                <button class="layui-btn layui-btn-sm data-plan-btn" lay-event="seeInfo"> 查看租户信息 </button>
                <button class="layui-btn layui-btn-normal layui-btn-sm data-plan-btn" lay-event="outputStudentInformation"> 导出所有租户信息 </button>
            </div>
        </script>
        <!--表格容器-->
    ...
    layui.use(['form', 'table','laydate', "upload", "element", "layer"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'snum', title: '用户号', sort: true},
                {field: 'ssex', title: '性别'},
                {field: 'sage', title: '年龄', sort: true},
                {field: 'cname', title: '所属组织'},
