...
<div class="site-text" style="margin: 5%; display: none" id="edit_window">
    <div class="layui-form" style="width: 400px;" lay-filter="editForm">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">摄影室</label>
            <div class="layui-input-block">
                <input type="text" id="rname" name="rname" value="" lay-verify="required" lay-reqtext="摄影室不能为空" placeholder="请输入姓名" class="layui-input">
            </div>
        </div>
        <!--容量-->
        <div class="layui-form-item">
    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-normal layui-btn-sm data-add-btn" lay-event="add"> 添加摄影室 </button>
