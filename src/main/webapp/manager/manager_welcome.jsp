                        ...
                        <div class="welcome-module">
                            <div class="layui-row layui-col-space10 layuimini-qiuck">
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="manager/student_list.jsp" data-title="婚纱管理" data-icon="fa fa-pencil">
                                        <i class="fa fa-pencil"></i>
                                        <cite>婚纱管理</cite>
                                    </a>
                                </div>
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="manager/teacher_list.jsp" data-title="摄影管理" data-icon="fa fa-briefcase">
                                        <i class="fa fa-briefcase"></i>
                                        <cite>摄影管理</cite>
                                    </a>
                                </div>
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="manager/clazz_list.jsp" data-title="预约管理" data-icon="fa fa-window-maximize">
                                        <i class="fa fa-window-maximize"></i>
                                        <cite>预约管理</cite>
                                    </a>
                                </div>
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="manager/room_list.jsp" data-title="摄影室管理" data-icon="fa fa-bank">
                                        <i class="fa fa-bank"></i>
                                        <cite>摄影室管理</cite>
                                    </a>
                                </div>
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="manager/open_course_list.jsp" data-title="化妆室管理" data-icon="fa fa-calendar">
                    ...
                    <div class="layui-card-body layui-text">
                        <table class="layui-table">
                            ...
                            <tr>
                                <td>演示地址</td>
                                <td>
                                    在线演示：<a href="http://47.97.104.230:8098/WeddingPhotoManager/index.jsp" target="_blank">点击查看</a><br>
                                    管理员账号：admin       密码：admin<br>
                                    摄影师账号：15001       密码：123456<br>
                                    预约账号：2020710001  密码：123456<br>
                                </td>
                            </tr>
                            <tr>
                                <td>下载地址</td>
                                <td>
                                    <a href="https://github.com/huanfenz/WeddingPhotoManager" target="_blank">github</a> / <a href="https://gitee.com/huanfenz/WeddingPhotoManager" target="_blank">gitee</a><br>
