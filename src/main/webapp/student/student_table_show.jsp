    ...
    <div style="margin: 10px 10px 10px 10px;">
        <form class="layui-form layui-form-pane" action="" lay-filter="searchForm">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="year" id="search_year" lay-search="">
                            <option value="">请选择拍摄时间</option>
                            <!--从2021到2030-->
                            <c:forEach begin="2021" end="2030" var="i">
                                <option value="${i}-${i + 1}拍摄时间">${i}-${i + 1}拍摄时间</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                <!--档期-->
                <div class="layui-inline">
                    <label class="layui-form-label">档期</label>
                    <div class="layui-input-inline">
                        <select name="term" id="search_term" lay-search="">
                            <option value="">请选择档期</option>
                            <option value="第一档期">第一档期</option>
                            <option value="第二档期">第二档期</option>
                        </select>
                    </div>
                </div>
                <%--周数--%>
