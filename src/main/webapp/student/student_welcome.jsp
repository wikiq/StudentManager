                    ...
                    <div class="layui-card-body">
                        <div class="welcome-module">
                            <div class="layui-row layui-col-space10 layuimini-qiuck">
                                ...
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="student/student_table_show.jsp" data-title="档期查看" data-icon="fa fa-table">
                                        <i class="fa fa-table"></i>
                                        <cite>档期查看</cite>
                                    </a>
                                </div>
                                <div class="layui-col-xs3 layuimini-qiuck-module">
                                    <a href="javascript:;" layuimini-content-href="student/student_score.jsp" data-title="结果查询" data-icon="fa fa-graduation-cap">
