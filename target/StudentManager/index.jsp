        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="" lay-filter="loginForm">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="username" name="username" lay-verify="required|account" placeholder="用户号、职工号、管理员用户名" autocomplete="off" class="layui-input" value="admin">
                </div>
                <%--密码--%>
                <div class="layui-form-item">
