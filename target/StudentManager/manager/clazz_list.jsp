    ...
    <div class="layui-form" style="width: 400px;" lay-filter="editForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="cname" name="cname" value="" lay-verify="required" lay-reqtext="组织名不能为空" placeholder="请输入组织名" class="layui-input">
            </div>
        </div>
        <!--专业-->
        <div class="layui-form-item">
    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-normal layui-btn-sm data-add-btn" lay-event="add"> 添加组织 </button>
